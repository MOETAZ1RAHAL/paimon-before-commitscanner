...
/**
 * Scan commits to provide information for {@link org.apache.paimon.operation.FileStoreCommitImpl}.
 */
public class CommitScanner {
    ...
    public CommitScanner(FileStoreScan scan, IndexManifestFile indexManifestFile, int numBucket) {
        this.scan = scan;
